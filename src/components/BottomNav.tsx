...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-gray-100 px-4 py-2 z-[100] shadow-[0_-5px_20px_rgba(0,0,0,0.05)] lg:hidden">
